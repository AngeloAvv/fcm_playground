...
class NotificationTitleField extends StatelessWidget {
  ...
  const NotificationTitleField({required this.formControlName, super.key});

  @override
  Widget build(BuildContext context) => Padding(
    padding: const EdgeInsets.symmetric(horizontal: 16.0, vertical: 8.0),
    child: FcmReactiveTextField(
      label: context.l10n?.labelNotificationTitle ?? 'labelNotificationTitle',
      formControlName: formControlName,
      decoration: InputDecoration(
        hintText: context.l10n?.hintNotificationTitle,
      ),
